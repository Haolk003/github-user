...
const StarLang = () => {
  ...
  return (
    <div className='w-[100%] bg-white h-[400px] rounded-md p-3'>
      <h2 className='text-center font-semibold text-2xl '>Stars Per Language</h2>
      <AccumulationChartComponent id="pie-charts"  width='100%' height='350px' legendSettings = {{enable:true}}   enableSmartLabels={false} enableAnimation={true} tooltip={{ enable: true}}>
        <Inject services={[AccumulationLegend,AccumulationDataLabel,AccumulationTooltip,PieSeries]} />
        <AccumulationSeriesCollectionDirective>
          <AccumulationSeriesDirective dataSource={mostUsed}  xName="label" yName='stars' explodeOffset='10%' explodeIndex={0} innerRadius="50%"
                  dataLabel={{
                    visible: true,
